module.exports = {
  TOKEN: process.env.TOKEN || "MTE0MDE3MjQ5OTU5ODk3MDk5MA.G3cDGM.P8Qe6Qhw6VbhtJYwCBp-uIsNSOz-KkDQ829suM",
  PREFIX: process.env.PREFIX || "/",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded By Aarav | Ruthless",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "1140189409610838039", // for slash command
  },
};
